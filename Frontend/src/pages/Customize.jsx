...
function Customize() {
  ...
  return (
    <div className="  w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] ">
      ...
      <div className="w-full max-w-[900px] flex justify-center items-centerb flex-wrap gap-[15px] ">
        <Cards image={image1} />
        <Cards image={image2} />
        <Cards image={image3} />
        <Cards image={image4} />
      ...
      {selectedImage && (
        <button
          className="min-w-[150px] h-[60px] bg-white rounded-full cursor-pointer text-black font-semibold text-[19px] mt-[30px]"
